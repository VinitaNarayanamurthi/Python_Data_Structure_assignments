...
class Kebab:
    ...
    def usage(self):
        ...
        print("calories - displays total number of calories of all items ")
    ...
    def calories(self, args):
        ...
        if self.skewer.calories():
            print('the total calories in the skewer is', self.skewer.calories())
        else:
            print("the skewer is empty, can't tell about the calories")
